// Adapted from dpowcoin/src/crypto/sha512.cpp (Bitcoin Core-derived, MIT licensed).
// Original license notice preserved below, per the source project's terms.
//
// Copyright (c) 2014-present The Bitcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
//
// Standalone adaptation for libmultihash: the only external dependency in
// the original file was crypto/common.h, used solely for ReadBE64/WriteBE64.
// Those two helpers are inlined below so this file has zero dependencies on
// the rest of the dpowcoin/Bitcoin Core tree. The algorithm itself,
// including all round constants, is untouched.

#include "sha512_dpowcoin.h"
...
////// SHA-512 (dpowcoin salt derivation)

CSHA512Dpowcoin::CSHA512Dpowcoin()
{
    sha512::Initialize(s);
}

CSHA512Dpowcoin& CSHA512Dpowcoin::Write(const unsigned char* data, size_t len)
{
...
void CSHA512Dpowcoin::Finalize(unsigned char hash[OUTPUT_SIZE])
{
...
CSHA512Dpowcoin& CSHA512Dpowcoin::Reset()
{
    bytes = 0;
    sha512::Initialize(s);
    return *this;
